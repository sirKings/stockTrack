...
class TipListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        header.text = call.toUpperCase()
        backBtn.setOnClickListener {
            finish()
        }

        tipsRecyclerView = tipsRV
        ...
        val query = FirebaseDatabase.getInstance().reference.child("tips").orderByChild("nameSec").equalTo(call)
        setup(query)
    ...
    fun setup(query: Query){
        ...
        options = FirebaseRecyclerOptions.Builder<Tip>()
                ...
                .build()
        adapter = TipsAdapter(options!!, this)
    ...
    fun addTip(){
        val addIntent = Intent(this@TipListActivity, AddTipActivity::class.java)
            ...
            fun bindItem(tip: Tip) {
                if (tip.isNewstype != true){
                    ...
                    expertName.setOnClickListener {
                        ...
                        val intent = Intent(this@TipListActivity, TableActivity::class.java)
                    ...
                    if (tip.canTrade == true){
                        ...
                        itemView.callCard.setOnClickListener {
                            if(getTipStatus(tip)){
                                Toast.makeText(this@TipListActivity, "Already traded by you", Toast.LENGTH_SHORT).show()
                            }else if (tip.status == false){
                                Toast.makeText(this@TipListActivity, "Call has been closed", Toast.LENGTH_SHORT).show()
                            }else{
                                ...
                                itemView.goToTrade.setOnClickListener {
                                    tipAdapterPosition = adapterPosition
                                    startActivity(Intent(this@TipListActivity, TradeActivity::class.java))
                                }
                            }
                        }
                    }else{
                        ...
                        itemView.callCard.setOnClickListener {
                            Toast.makeText(this@TipListActivity, "This tip can not be traded", Toast.LENGTH_SHORT).show()
                        }
                    }
                    ...
                    itemView.tipReadMore.setOnClickListener {
                        if(isAdmin){
                            tipAdapterPosition = adapterPosition
                            val intent = Intent(this@TipListActivity, ReadMoreActivity::class.java)
                    ...
                    itemView.newsSection.visibility = View.VISIBLE
                    ...
                    if (tip.expertName != null){
                        ...
                        itemView.newsTitle.setOnClickListener {
                            tipAdapterPosition = adapterPosition
                            val intent = Intent(this@TipListActivity, NewsActivity::class.java)
...
//        alert.show()
    ...
    fun editNews(id: String){
        val intent = Intent(this, EditNewsAsTip::class.java)
